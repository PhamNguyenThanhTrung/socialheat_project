...
<head>
    ...
    <div class="colod" style="font-size: 14px;z-index: 101;">
        <div class="row noew">
            <div class="col-lg-2 ">

                <nav class="navbar navbar-expand-lg navbar-light " style="z-index: 100; position: fixed;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="d-flex" id="wrapper" style="width: 300px;">
                            <!-- Sidebar-->
                            <div class="list-group-item-secondary1 " style=" border-radius: 20px;min-height: 90vh;">
                                <div class="sidebar-heading list-group-item-secondary" style="border-radius:10px;padding-top:20px">
                                    <p style=" font-size: 25px;"><strong><span class="colored-text text-lg " style="  background-color: DarkBlue;color: white;border-radius:5%;padding-right:5px;
                                ...
                                <div class="list-group list-group-flush " border:none style="width:75%">
                                    ...
                                    <a class="list-group-item list-group-item-action list-group-item-secondary p-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" aria-expanded="false" aria-controls="collapseWidthExample" href="#!"><img src="/assets/img/admin.svg"><strong> Admin</strong></a>



                                    <div style="height:90px">
                                        <div class="collapse collapse-horizontal" id="collapseWidthExample">
                                            <div class="card card-body list-group-item-secondary " style="width: 200px;border:none;">

                                                <li class="list-group-item list-group-item-secondary " style="line-height: 0.5;"><i class="bi bi-dot"></i>
                                                    An item</li>
                                ...
                                <div class="container mt-2">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-4 mt-1" style="width:40%">
                                            <style>
                                                .btn-secondary {
                                            ...
                                            <div class="dropdown dropup" style="position: absolute; overflow: visible;">
                                                <button class="btn btn-secondary" type="button" id="dropdownMenuButton">
                                                    <i class="bi bi-gear" id="gearIcon"></i>
                                                </button>
                                                <ul class="dropdown-menu dropdown-menu-dark" style="position: absolute; top: -200%; right: 0;" id="myDropdown">
